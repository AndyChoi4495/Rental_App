...
const SignUpScreen = ({ navigation }) => {
    const [email, setEmail] = useState('yunseok@gmail.com');
    ...
    const handleSignUp = async () => {
        ...
        try {
            ...
            const docRef = await addDoc(collection(db, 'Users'), { id: currentUserId });
            console.log(docRef.id);
            navigation.navigate('Main');
        } catch (err) {
            console.log('Cannot creating user');
            setErrorMessageLabel('Cannot creating user');
